...
// Obter a lista de projetos baseados na pesquisa
if ($query) {
    // Se houver um termo de pesquisa, chamamos o método de busca
    $projetos = $projetoController->buscarProjetosPorNome($query);
} else {
    // Caso contrário, mostramos todos os projetos
...
<div class="container">
    ...
    <?php else: ?>
        <p class="no-results">Nenhum projeto encontrado para "<?php echo htmlspecialchars($query); ?>"</p>
    <?php endif; ?>
</div>
